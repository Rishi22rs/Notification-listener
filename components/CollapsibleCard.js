...
const CollapsibleCard = ({time="62394", app="whatsapp", body="THis idhlghdihfddggdjsdgjpgdspidghidghb odghldsbg godshldg oidbg sdvgbsiov aboevi eivbiowev wvbivew wevwevwbv wue v b", collapsibleText="THis idhlghdihfddggdjsdgjpgdspidghidghb odghldsbg godshldg oidbg sdvgbsiov aboevi eivbiowev wvbivew wevwevwbv wue v b"}) => {
  ...
  const renderHeader = (section, _, isActive) => {
    return (
      <Animatable.View
        ...
        <Card time={time} app={app} body={body} />
      </Animatable.View>
    );
  };
